...
// Admin dashboard page (Requirements 10.5, 11.1, 11.5, 11.16).
//
// The content-management surface for an authenticated Admin. Every mutation is
// performed through the `useAdminMaterials` hook, which sends the persisted
// role_admin Bearer token so only an Admin holding role_admin may perform these
// Content Management Actions (Req 10.5, 11.16). An unauthenticated visitor is
// redirected to the account page to sign in.
//
// Capabilities:
...
// management surface. All styling lives in `page.module.scss` (no inline CSS).
